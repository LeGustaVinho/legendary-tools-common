...
namespace LegendaryTools.Systems.ScreenFlow.Editor
{
    public static class ScreenFlowConfigCreator
    {
        ...
        [MenuItem("Assets/Create/Legendary Tools/Screen Flow/Configuration/Screen or Popup", false, 80)]
        ...
        [MenuItem("Assets/Create/Legendary Tools/Screen Flow/Configuration/Screen or Popup", true)]
