...
namespace LegendaryTools
{
    public class Bictionary<TKey,TValue> : IDictionary<TKey, TValue>
    {
...
#if UNITY_EDITOR
        [Sirenix.OdinInspector.OnCollectionChanged(After = "ForwardAfterChange")]
#endif
#endif
        ...
        [Sirenix.Serialization.OdinSerialize]
#if UNITY_EDITOR
        [Sirenix.OdinInspector.OnCollectionChanged(After = "BackwardAfterChange")]
#endif
#endif
        ...
        private void ForwardAfterChange(Sirenix.OdinInspector.Editor.CollectionChangeInfo info, object value)
        {
            backward.Clear();
            foreach (KeyValuePair<TKey, TValue> pair in forward)
            {
                backward.Add(pair.Value, pair.Key);
            }
        }
        
        private void BackwardAfterChange(Sirenix.OdinInspector.Editor.CollectionChangeInfo info, object value)
        {
            forward.Clear();
            foreach (KeyValuePair<TValue, TKey> pair in backward)
            {
