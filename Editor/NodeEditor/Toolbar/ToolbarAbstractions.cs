...
namespace LegendaryTools.NodeEditor
{
    ...
    public sealed class ToolbarContext
    {
        ...
        public IReadOnlyCollection<IEditorNode> SelectedNodes { get; }

        public IReadOnlyCollection<IEditorNodeEdge<IEditorNode>> SelectedEdges { get; }
        ...
        public ToolbarContext(
            Graph graph,
            IReadOnlyCollection<IEditorNode> selectedNodes,
            IReadOnlyCollection<IEditorNodeEdge<IEditorNode>> selectedEdges,
