...
namespace LegendaryTools.NodeEditor
{
    ...
    /// </summary>
    public class NodeEditorContext
    {
        ...
        public readonly HashSet<IEditorNode> SelectedNodes = new();

        /// <summary>Edges selected (abstractions to keep LSP).</summary>
        public readonly HashSet<IEditorNodeEdge<IEditorNode>> SelectedEdges = new();

        /// <summary>Inspector editors cache: node.</summary>
        public UnityEditor.Editor CachedNodeEditor;

        /// <summary>Inspector editors cache: edge.</summary>
        public UnityEditor.Editor CachedEdgeEditor;
    ...
    /// </summary>
    public readonly struct NodeEditorLayout
    {
