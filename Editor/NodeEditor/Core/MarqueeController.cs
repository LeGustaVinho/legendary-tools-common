...
namespace LegendaryTools.NodeEditor
{
    ...
    public class MarqueeController
    {
        ...
        /// </summary>
        public void HandleMarquee(NodeEditorContext ctx, Rect canvasRect, System.Func<IEditorNode, Rect> getNodeRect)
        {
        ...
        /// </summary>
        public void DrawOverlay(NodeEditorContext ctx, Rect canvasRect)
        {
