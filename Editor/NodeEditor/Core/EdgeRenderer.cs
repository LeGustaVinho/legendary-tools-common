...
namespace LegendaryTools.NodeEditor
{
    ...
    public class EdgeRenderer
    {
        ...
        /// </summary>
        public void DrawEdges(NodeEditorContext ctx, Rect canvasRect)
        {
            foreach (IEditorNodeEdge<IEditorNode> e in ctx.Graph.Edges)
            {
            ...
            {
                IEditorNode from = ctx.Graph.Nodes.FirstOrDefault(n => n != null && n.Id == ctx.PendingFromNodeId);
                if (from != null)
                {
        ...
        /// </summary>
        private void DrawEdgeInternal(IEditorNodeEdge<IEditorNode> e, bool selected, NodeEditorContext ctx)
        {
        ...
        /// </summary>
        private bool TryGetSegment(IEditorNodeEdge<IEditorNode> e, NodeEditorContext ctx, out Vector2 a, out Vector2 b)
        {
            a = b = default;
