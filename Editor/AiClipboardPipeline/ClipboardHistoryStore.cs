...
namespace AiClipboardPipeline.Editor
{
    ...
    public sealed class ClipboardHistoryStore : ScriptableSingleton<ClipboardHistoryStore>
    {
        ...
        // Global last apply/operation error report.
        ...
        // Unified compilation error report (generated by AiFriendlyCompilationErrorReporter).
        [SerializeField] private string lastCompilationErrorReport = string.Empty;

        // Timestamp for lastCompilationErrorReport (UTC ticks).
        [SerializeField] private long lastCompilationErrorReportTicks;
        ...
        public string LastCompilationErrorReport => lastCompilationErrorReport ?? string.Empty;

        /// <summary>
        /// UTC ticks when LastCompilationErrorReport was last written.
        /// </summary>
        public long LastCompilationErrorReportTicks => lastCompilationErrorReportTicks;
        ...
        {
            if (entries.Count == 0 &&
                string.IsNullOrEmpty(lastErrorReport) &&
                string.IsNullOrEmpty(lastCompilationErrorReport))
                return;
            ...
            lastCompilationErrorReport = string.Empty;
            lastCompilationErrorReportTicks = 0;
        ...
        public void SetLastCompilationErrorReport(string report)
        {
            lastCompilationErrorReport = report ?? string.Empty;
            lastCompilationErrorReportTicks =
                string.IsNullOrEmpty(lastCompilationErrorReport) ? 0 : DateTime.UtcNow.Ticks;
